...
func Example_ledgerentrieshistoryarchive() {
	archiveURL := "http://history.hcnet.org/prd/core-live/core_live_001"
...
// for a specific ledger using captive hcnet-core. Please note that transaction
...
func Example_changes() {
	...
	// Requires Hcnet-Core 13.2.0+
	backend, err := ledgerbackend.NewCaptive(
		ledgerbackend.CaptiveCoreConfig{
			BinaryPath:         "/bin/hcnet-core",
			NetworkPassphrase:  networkPassphrase,
			HistoryArchiveURLs: []string{archiveURL},
