...
Ledger backends are sources of information about Hcnet network ledgers. This
can be, for example: a Hcnet-Core database, (possibly-remote) Captive
Hcnet-Core instances, or History Archives. Please consult the "ledgerbackend"
...
guide: https://github.com/sanjayhashcash/go/blob/master/ingest/README.md
*/
package ingest
