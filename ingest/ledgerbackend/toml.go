...
const (
	...
	// if LOG_FILE_PATH is omitted hcnet core actually defaults to "hcnet-core.log"
...
type captiveCoreTomlValues struct {
	...
	// and the default is hcnet-core.log
	...
	c.captiveCoreTomlValues.Validators = []Validator{
		{
			...
			Address:    "core-live-a.hcnet.org:11625",
			History:    "curl -sf https://history.hcnet.org/prd/core-live/core_live_001/{0} -o {1}",
		},
		{
			Name:       "sdf_2",
			HomeDomain: "hcnet.org",
			PublicKey:  "GCM6QMP3DLRPTAZW2UZPCPX2LF3SXWXKPMP3GKFZBDSF3QZGV2G5QSTK",
			Address:    "core-live-b.hcnet.org:11625",
			History:    "curl -sf https://history.hcnet.org/prd/core-live/core_live_002/{0} -o {1}",
		},
		{
			Name:       "sdf_3",
			HomeDomain: "hcnet.org",
			PublicKey:  "GABMKJM6I25XI4K7U6XWMULOUQIQ27BCTMLS6BYYSOWKTBUXVRJSXHYQ",
			Address:    "core-live-c.hcnet.org:11625",
			History:    "curl -sf https://history.hcnet.org/prd/core-live/core_live_003/{0} -o {1}",
		},
	}
}
...
func (c *CaptiveCoreToml) validate(params CaptiveCoreTomlParams) error {
	...
	if def := c.tree.Has("EXPERIMENTAL_BUCKETLIST_DB"); def && !params.UseDB {
		return fmt.Errorf(
			"BucketListDB enabled in captive core config file, requires Aurora flag --captive-core-use-db",
		)
	}
