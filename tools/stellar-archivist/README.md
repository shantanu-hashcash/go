...
```
$ go install github.com/sanjayhashcash/go/tools/hcnet-archivist
```
...
```
$ hcnet-archivist mirror --recent http://history.hcnet.org/prd/core-live/core_live_001 file://local-archive

2019/08/21 13:53:15 mirroring http://history.hcnet.org/prd/core-live/core_live_001 -> file://local-archive
...
```
$ hcnet-archivist --last 1024 mirror http://history.hcnet.org/prd/core-testnet/core_testnet_001 file://local-archive
