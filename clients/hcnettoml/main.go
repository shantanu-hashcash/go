...
type ClientInterface interface {
	...
	GetHcnetTomlByAddress(addr string) (*Response, error)
}
...
// SEP-1 commit
// https://github.com/sanjayhashcash/hcnet-protocol/blob/f8993e36fa6b5b8bba1254c21c2174d250af4958/ecosystem/sep-0001.md
...
// given address
func GetHcnetTomlByAddress(addr string) (*Response, error) {
	return DefaultClient.GetHcnetTomlByAddress(addr)
}
