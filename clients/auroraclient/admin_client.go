...
// host - the host interface name that aurora has bound admin web service, zero value defaults to 'localhost'
...
// ensure that the aurora admin client implements AdminClientInterface
