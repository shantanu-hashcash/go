...
func (c *Client) sendHTTPRequest(req *http.Request, a interface{}) error {
	...
	if resp, err := c.HTTP.Do(req.WithContext(ctx)); err != nil {
		...
		return decodeResponse(resp, a, c.AuroraURL, c.clock)
	}
}
...
// See https://developers.hcnet.org/api/resources/accounts/
...
// See https://developers.hcnet.org/api/resources/accounts/single/
...
// See https://developers.hcnet.org/api/resources/accounts/data/
...
// Effects returns effects (https://developers.hcnet.org/api/resources/effects/)
...
// See https://developers.hcnet.org/api/resources/assets/list/
...
// See https://developers.hcnet.org/api/resources/ledgers/list/
...
// See https://developers.hcnet.org/api/resources/ledgers/single/
...
// See https://developers.hcnet.org/api/aggregations/fee-stats/
...
// See https://developers.hcnet.org/api/resources/offers/list/
...
// See https://developers.hcnet.org/api/resources/offers/single/
...
// Operations returns hcnet operations (https://developers.hcnet.org/api/resources/operations/list/)
...
// OperationDetail returns a single hcnet operation for a given operation id
// See https://developers.hcnet.org/api/resources/operations/single/
...
// See https://developers.hcnet.org/api/resources/transactions/single/
...
// Paths returns the available paths to make a strict receive path payment. See https://developers.hcnet.org/api/aggregations/paths/strict-receive/
...
// Trades returns hcnet trades (https://developers.hcnet.org/api/resources/trades/list/)
...
// https://developers.hcnet.org/docs/tutorials/create-account/ for more information.
