...
func IncludeContractIDsInAssetStats(
	...
	// contract data ledger entry with the Hcnet asset metadata.
	...
	// There is also a corner case where a Hcnet Asset contract is initialized before there exists any
	// trustlines / claimable balances for the Hcnet Asset. In this case, when ingesting contract data
