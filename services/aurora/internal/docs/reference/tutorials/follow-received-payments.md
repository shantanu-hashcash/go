...
using JavaScript and `EventSource`.  We will eschew using [`js-hcnet-sdk`](https://github.com/sanjayhashcash/js-hcnet-sdk), the
...
> If you need a reliable streaming connection please use our [SDK](https://github.com/sanjayhashcash/js-hcnet-sdk).
