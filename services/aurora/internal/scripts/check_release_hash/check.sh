...
apt-get clean
apt-get update
apt-get install -y hcnet-aurora=$PACKAGE_VERSION

mkdir released
cd released

wget https://github.com/sanjayhashcash/go/releases/download/$TAG/$TAG-darwin-amd64.tar.gz
wget https://github.com/sanjayhashcash/go/releases/download/$TAG/$TAG-linux-amd64.tar.gz
wget https://github.com/sanjayhashcash/go/releases/download/$TAG/$TAG-linux-arm.tar.gz
wget https://github.com/sanjayhashcash/go/releases/download/$TAG/$TAG-windows-amd64.zip
