...
import (
	...
	"github.com/sanjayhashcash/go/services/aurora/internal/corestate"
	"github.com/sanjayhashcash/go/services/aurora/internal/db2/history"
	"github.com/sanjayhashcash/go/services/aurora/internal/httpx"
	"github.com/sanjayhashcash/go/services/aurora/internal/ingest"
	"github.com/sanjayhashcash/go/services/aurora/internal/ledger"
	"github.com/sanjayhashcash/go/services/aurora/internal/operationfeestats"
	"github.com/sanjayhashcash/go/services/aurora/internal/paths"
	"github.com/sanjayhashcash/go/services/aurora/internal/reap"
...
func (a *App) UpdateCoreLedgerState(ctx context.Context) {
	...
	if err != nil {
		logErr(err, "failed to load the hcnet-core info")
		return
	}
...
func (a *App) Tick(ctx context.Context) error {
	...
	go func() { err = a.UpdateHcnetCoreInfo(ctx); wg.Done() }()
	wg.Wait()
	if err != nil {
		return err
	}
