...
var ingestBuildStateCmdOpts = []*support.ConfigOption{
	...
	},
	{
		...
		Required:    false,
		FlagDefault: false,
		Usage:       "[optional] set to skip protocol version and bucket list hash verification, can speed up the process because does not require a running Hcnet-Core",
	},
}
...
var ingestBuildStateCmd = &cobra.Command{
	...
	Long:  "useful for debugging or starting Aurora at specific checkpoint.",
	RunE: func(cmd *cobra.Command, args []string) error {
