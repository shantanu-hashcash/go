...
export HORIZON_INTEGRATION_TESTS_CAPTIVE_CORE_BIN=${HORIZON_INTEGRATION_TESTS_CAPTIVE_CORE_BIN:-/usr/bin/hcnet-core}
...
exec go test -timeout 35m github.com/sanjayhashcash/go/services/aurora/internal/integration/... "$@"
