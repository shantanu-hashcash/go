...
// See https://developers.hcnet.org/docs/glossary/accounts/#flags
...
// See https://developers.hcnet.org/docs/glossary/multisig/
...
// https://developers.hcnet.org/docs/glossary/federation/
...
func (so *SetOptions) Validate() error {
	...
	// Refactoring is out of the scope of this issue(https://github.com/sanjayhashcash/go/issues/1041) so will leave as is for now.
	return nil
}
