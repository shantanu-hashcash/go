...
func (r *RevokeSponsorship) Validate() error {
	...
	case RevokeSponsorshipTypeAccount:
		...
		return validateHcnetPublicKey(*r.Account)
	case RevokeSponsorshipTypeTrustLine:
		if r.TrustLine == nil {
			return errors.New("Trustline can't be nil")
		}
		if err := validateHcnetPublicKey(r.TrustLine.Account); err != nil {
			return errors.Wrap(err, "invalid Account address")
		}
		if err := validateHcnetAsset(r.TrustLine.Asset); err != nil {
	...
	case RevokeSponsorshipTypeOffer:
		...
		if err := validateHcnetPublicKey(r.Offer.SellerAccountAddress); err != nil {
			return errors.Wrap(err, "invalid Seller account address")
		}
		return validateHcnetPublicKey(r.Offer.SellerAccountAddress)
	case RevokeSponsorshipTypeData:
		if r.Data == nil {
			return errors.New("Data can't be nil")
		}
		if err := validateHcnetPublicKey(r.Data.Account); err != nil {
			return errors.Wrap(err, "invalid Account address")
		}
	case RevokeSponsorshipTypeClaimableBalance:
		if r.ClaimableBalance == nil {
	...
	case RevokeSponsorshipTypeSigner:
		...
		if err := validateHcnetPublicKey(r.Signer.AccountID); err != nil {
			return errors.New("invalid Account address")
		}
		if err := validateHcnetSignerKey(r.Signer.SignerAddress); err != nil {
