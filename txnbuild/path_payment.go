...
// PathPayment represents the Hcnet path_payment operation. This operation was removed
// in Hcnet Protocol 12 and replaced by PathPaymentStrictReceive.
...
// PathPaymentStrictReceive represents the Hcnet path_payment_strict_receive operation. See
...
func (pp *PathPaymentStrictReceive) Validate() error {
	...
	err = validateHcnetAsset(pp.SendAsset)
	if err != nil {
		return NewValidationError("SendAsset", err.Error())
	}

	err = validateHcnetAsset(pp.DestAsset)
	if err != nil {
