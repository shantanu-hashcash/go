...
programmers is auroraclient (https://github.com/sanjayhashcash/go/tree/master/clients/auroraclient). Together, these two
libraries provide a complete Hcnet SDK.
For more information and further examples, see https://github.com/sanjayhashcash/go/blob/master/docs/reference/readme.md
*/
package txnbuild
...
// https://developers.hcnet.org/docs/glossary/accounts/
...
func stringsToKP(keys ...string) ([]*keypair.Full, error) {
	...
	for _, k := range keys {
		...
		if err != nil {
			return nil, errors.Wrapf(err, "provided string %s is not a valid Hcnet key", k)
		}
		kpf, ok := kp.(*keypair.Full)
		if !ok {
			return nil, errors.New("provided string %s is not a valid Hcnet secret key")
		}
...
// https://developers.hcnet.org/docs/glossary/transactions/
...
// See description here: https://developers.hcnet.org/docs/glossary/multisig/#hashx
...
func (t *Transaction) ClaimableBalanceID(operationIndex int) (string, error) {
	...
	// https://github.com/sanjayhashcash/hcnet-core/blob/9f3cc04e6ec02c38974c42545a86cdc79809252b/src/test/TestAccount.cpp#L285
	//
...
// More details on SEP 10: https://github.com/sanjayhashcash/hcnet-protocol/blob/master/ecosystem/sep-0010.md
func BuildChallengeTx(serverSignerSecret, clientAccountID, webAuthDomain, homeDomain, network string, timebound time.Duration, memo *MemoID) (*Transaction, error) {
	...
	// https://github.com/sanjayhashcash/hcnet-protocol/blob/master/ecosystem/sep-0010.md#response
...
//
// The returned clientAccountID may be a Hcnet account (G...) or Muxed account (M...) address. If
// the address is muxed, or if the memo returned is non-nil, the challenge transaction
// is being used to authenticate a user of a shared Hcnet account.
...
// verifyTxSignature checks if a transaction has been signed by the provided Hcnet account.
